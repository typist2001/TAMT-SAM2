...
curr_results = {
    ...
    "ber": fmv2["ber"]["dynamic"].mean(),
    "sample_biber": fmv2["sample_biber"],
    "overall_biber": fmv2["overall_biber"],
    'Smeasure': sm,
...
print("ber:       ", format(curr_results['ber'], '.3f'))
print(curr_results["sample_biber"])
print(curr_results["overall_biber"])
